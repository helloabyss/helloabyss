# ARCHIVE.md — stories covered

Running log of every story that has aired on **This Week in Tech**. `/twit` reads this at
Step 0 and **drops any candidate already listed**, before scoring.

Add a row for every story in every episode — including the wildcard. A story is "covered"
once it has been a beat; a later, genuinely new development on the same subject is a new
story, and the *Development* column is where that judgement gets recorded.

| Date aired | Story | Beat | Original event date | Episode | Development that would make it eligible again |
|---|---|---|---|---|---|
| 2026-09-20 | Google Home opens to third-party AI agents (Home MCP) | 1 | 2026-09-16 | `scripts/2026-09-20.md` | Leaves early access, exits the US, drops the $20/mo tier, or the door-unlock block is removed |
...
## Held for a future episode

Scored well but deliberately not used. Not archived — these are still **eligible**.
